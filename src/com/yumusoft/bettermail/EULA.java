...
class Eula {
    ...
    static boolean show(final Activity activity) {
        final SharedPreferences preferences = 
        	activity.getSharedPreferences(PREFERENCES_EULA, 
        ...
        if (!preferences.getBoolean(PREFERENCE_EULA_ACCEPTED, false)) {
            ...
            builder.setPositiveButton(R.string.dialog_button_accept, 
            ...
            builder.setNegativeButton(R.string.dialog_button_refuse, new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    refuse(activity);
                }
            });
